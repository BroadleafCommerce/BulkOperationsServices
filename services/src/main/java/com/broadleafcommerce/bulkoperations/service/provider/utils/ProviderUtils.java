 ...
 */
package com.broadleafcommerce.bulkoperations.service.provider.utils;
...
public class ProviderUtils {
     ...
     */
    public HttpHeaders getHeaders(@Nullable final ContextInfo contextInfo) {
     ...
     */
    public <T> T executeRequest(Supplier<T> request) {
        try {
            return request.get();
     ...
     */
    public MultiValueMap<String, String> pageableToParams(@Nullable Pageable pageable) {
     ...
     */
    protected String orderToParamValue(Sort.Order order) {
